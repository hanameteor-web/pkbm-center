        ...
        <div style="margin-bottom:20px;">
            ...
            >
                ...
                @foreach($classes as $class)
                    ...
                    <option
                        value="{{ $class->id }}"
                        {{ old('school_class_id', $attendance->school_class_id) == $class->id ? 'selected' : '' }}
                    >
                        {{ $class->name }}
                    </option>
            ...
            <small style="
                ...
                color:#8898aa;
            ">
                Kelas otomatis mengikuti siswa, tetapi tetap bisa diganti.
            </small>
            ...
            ">
                ...
                <label>
                    <input
                        ...
                        name="status"
                        value="sakit"
                        {{ old('status', $attendance->status) == 'sakit' ? 'checked' : '' }}
                    >
                    Sakit
                </label>
                ...
                <label>
                    <input
                        ...
                        name="status"
                        value="alpha"
                        {{ old('status', $attendance->status) == 'alpha' ? 'checked' : '' }}
                    >
                    Alpha
                </label>
